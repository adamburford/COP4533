...
def main():
    ...
    #    for y in (''.join(choices(ascii_uppercase + ascii_lowercase, k = 3)) for _ in range(101)): my_list.add(y)

    #    my_list.sort()
    #    test = sorted(my_list._BubbleStringList__list)

    #    if my_list._BubbleStringList__list != test:
    #        print("Failed")
    #        break
